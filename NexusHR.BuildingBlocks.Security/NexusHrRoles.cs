...
public static class NexusHrRoles
{
    ...
    public const string FinanceSpecialist = "FinanceSpecialist";
    ...
    public const string OnboardingReaders =
        "HrSpecialist,HrManager,DepartmentManager,ItSpecialist,Auditor";

    public const string OnboardingEditors =
        "HrSpecialist,ItSpecialist";
}
